<template>
  ...
  <div
    class="w-[150px] md:w-[200px] fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30"
    id="main-nav"
  >
    <div
      class="w-full h-20 border-b flex px-4 items-center mb-8 text-center justify-center"
    >
      <img src="/logo.png" alt="hr-est" class="w-[50px]" />
    </div>
    ...
    <div class="mb-4 px-4" dir="rtl">
      ...
      <router-link to="services">
        ...
        >
          ...
          <span class="text-gray-700">الخدمات</span>
        </div>
      </router-link>
    </div>
  </div>
...
<script setup>
import { ref } from "vue";
import { MdDesignServices } from "vue-icons-plus/md";
